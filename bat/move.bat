...
REM SET extensions
SET te=torrent
SET ie=jpg png gif jpeg bmp webp jfif jpe
SET we=webm
SET ee=exe msi
SET ce=rar zip 7z dmg
SET ve=mp4 avi flv ts mov wmv mkv 3gp m4v mpg 3gpp
...
SET oe5=renpy srt apk sdltm dll py pak ts4script ulf dat
SET oe6=gpl tar.bz2 ila cfg exr hdr tar tif woff2
...
FOR %%a IN (%oe%, %oe2%, %oe3%, %oe4%, %oe5%, %oe6%) DO MOVE *.%%a %o%
